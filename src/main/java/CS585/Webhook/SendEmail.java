...
public class SendEmail {
	...
	public static void To(String CommitersEmail, String folder){
		...
		try{
			...
			msg.setFrom(new InternetAddress("github.webhook@gmail.com", "Fariba"));

			msg.setReplyTo(InternetAddress.parse("ffderakhshan@gmail.com", false));
			...
			messageBodyPart.setText("You made some changes to the repository.");
